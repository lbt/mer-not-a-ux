...
Item {
    ...
    NumberAnimation on time {
        ...
        ShaderEffect {
            ...
            property variant source: ShaderEffectSource { sourceItem: shaderText; hideSource:true; mipmap:true }
            vertexShader: "
            ...
            fragmentShader: "
                    ...
                    uniform float shadertime;
                    void main() {
                        gl_FragColor = texture2D(source,qt_TexCoord0)*vec4(qt_TexCoord1.xy,qt_TexCoord1.x*qt_TexCoord1.y,1.0)*qt_Opacity;
                    }"
        }
    }
}
